#include "strategy/teamStrategy/StandardTeamStrategyNearest.h"

StandardTeamStrategyNearest::StandardTeamStrategyNearest(){}

std::string StandardTeamStrategyNearest::getName() const {
    return "StandardTeamStrategyNearest";
}

std::map<int, Vec2> StandardTeamStrategyNearest::getNextDestination(std::vector<PlayerEntry>& players, const GameState gameState, int teamID) {
...
void StandardTeamStrategyNearest::decideStrategy(std::vector<ZoneInfo> zoneInfos, int teamID) {
    int contested = 0;
...
ZoneInfo StandardTeamStrategyNearest::selectTargetZone(Player& player, std::vector<ZoneInfo> zoneInfos, int teamID) {
...
sf::Vector2f StandardTeamStrategyNearest::getSmartZonePosition(ZoneInfo z, const sf::Vector2f& playerPos) {
